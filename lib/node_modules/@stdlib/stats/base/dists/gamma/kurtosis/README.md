...
Evaluates the excess kurtosis for a erlang distribution with shape parameter `alpha` and rate parameter `beta` at a value `x`.

```c
double y = stdlib_base_dists_gamma_kurtosis( 1.0, 1.0 );
// returns ~6.0

y = stdlib_base_dists_gamma_kurtosis( 4.0, 12.0 );
// returns ~1.5

y = stdlib_base_dists_gamma_kurtosis( 8.0, 2.0 );
// returns ~0.75

y = stdlib_base_dists_gamma_kurtosis( 1.0, -0.1 );
// returns NaN

y = stdlib_base_dists_gamma_kurtosis( -0.1, 1.0 );
// returns NaN

y = stdlib_base_dists_gamma_kurtosis( 2.0, NaN );
// returns NaN

y = stdlib_base_dists_gamma_kurtosis( NaN, 2.0 );
// returns NaN
```
