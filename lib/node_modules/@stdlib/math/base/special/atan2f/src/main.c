...
*
* @example
* double v = stdlib_base_atan2f( 2.0, 2.0 ); // => stdlib_base_atanf(1.0)
* // returns ~0.785
*
* @example
* double v = stdlib_base_atan2f( 6.0, 2.0 ); // => stdlib_base_atanf(3.0)
* // returns ~1.249
*
* @example
* double v = stdlib_base_atan2f( -1.0, -1.0 ); // => stdlib_base_atanf(1.0) - π
* // returns ~-2.356
*
* @example
* double v = stdlib_base_atan2f( 3.0, 0.0 ); // => π/2
* // returns ~1.571
*
* @example
* double v = stdlib_base_atan2f( -2.0, 0.0 ); // => -π/2
* // returns ~-1.571
*
* @example
* double v = stdlib_base_atan2f( 0.0, 0.0 );
* // returns 0.0
*
* @example
* double v = stdlib_base_atan2f( 3.0, NaN );
* // returns NaN
*
* @example
* double v = stdlib_base_atan2f( NaN, 2.0 );
* // returns NaN
*/
